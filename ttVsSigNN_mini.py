...
cutDict = {"NGoodJets_pt45_double" : {"==" : list(xrange(6,11)) + [-1], ">=" : [11]}}

histDict = {
            #"GoodLeptons_pt_@"      : {"fudge" : 1.3, "logY" : False, "range" : [1,2],              "X" : {"title" : "Lepton @ p_{T} [GeV]",              "bins" : 80, "min" : 0, "max" : 360}},
            ...
            "HT_trigger_pt45"       : {"fudge" : 70,  "logY" : True,  "range" : [-1],               "X" : {"title" : "H_{T} [GeV]",                       "bins" : 64, "min" : 0, "max" : 5000}},
}
